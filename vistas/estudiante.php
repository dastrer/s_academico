                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <label>Edad:</label>
                                <input type="number" class="form-control" name="edad" id="edad" min="0" placeholder="Edad" required>
                                <small id="error-edad" class="text-danger"></small>
                            </div>
                            <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <label>Cédula:</label>
                            ...
                            <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <label>Celular:</label>
                                <input type="text" class="form-control" name="celular" id="celular" maxlength="15" placeholder="Celular" required>
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <small id="error-fecha_nac" class="text-danger"></small>
                            </div>
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
